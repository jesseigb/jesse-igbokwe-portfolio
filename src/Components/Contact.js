            ...
            <Container className="window box contact" id={props.active ? "active-window" : "hidden-window"}>
                ...
                <Row className="window-content work-minimised">
                    <Col xs={12}>
                        ...
                        <br></br>
                        <div className='bubble-title'>
                            <p><a href='https://www.linkedin.com/in/jesse-igbokwe-79341b203/' target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
                        </div>
                        <br></br>
                        <div className='bubble-title'>
                            <p><a href='https://github.com/jesseigb' target="_blank" rel="noopener noreferrer">GitHub</a></p>
                        </div>
                    </Col>
                </Row>
            </Container>
